...
public class Flight implements Runnable {
    ...
    public void run() {
        try {
            ...
            // Check if simulation is complete (this logic needs adjustment as per your
            // requirement)
    ...
    private void dock() throws InterruptedException {
        this.setGate(atc.assignGate()); // Assign a gate
    ...
    private void operateAirport() throws InterruptedException {
        ...
        this.getAtc().deployFuelService(this, this.getGate()); // Updated to pass both Flight and Gate
